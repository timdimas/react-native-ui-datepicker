...
export const getWeekdaysMin = firstDayOfWeek => {
 ...
 */
export const getMonthDays = (datetime = dayjs(), displayFullDays, minDate, maxDate, disabledDates, firstDayOfWeek) => {
...
const generateDayObject = (day, date, minDate, maxDate, disabledDates, isCurrentMonth, dayOfMonth) => {
  ...
  if (disabledDates) {
    if (Array.isArray(disabledDates)) {
      const dates = disabledDates.filter(disabledDate => areDatesOnSameDay(date, disabledDate));
