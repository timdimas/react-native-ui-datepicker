 ...
 */
export declare const getMonthDays: (datetime: DateType, displayFullDays: boolean, minDate: DateType, maxDate: DateType, disabledDates: DateType[] | ((date: DateType) => boolean) | undefined, firstDayOfWeek: number) => IDayObject[];
